...
public class AdBoot extends Application {
	...
	public void RegisterNetWorkReceiver() {
		...
		this.getApplicationContext().registerReceiver(mNetworkReceiver,
	...
	public boolean CheckNetWork() {
		if (Debug)
			Log.d("Jas", "CheckNetWork()");
		return Util.isNetworkAvailable(this.getApplicationContext());
	}
}
