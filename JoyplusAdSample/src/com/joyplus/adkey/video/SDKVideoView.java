...
public class SDKVideoView extends SurfaceView implements MediaPlayerControl {
	...
	private MediaPlayer.OnCompletionListener mCompletionListener = new MediaPlayer.OnCompletionListener() {
		...
		public void onCompletion(MediaPlayer mp) {
			 ...
			 */
			File file_temp = new File(Const.DOWNLOAD_PATH+Util.GetPackage(mContext)+Const.DOWNLOAD_READY_FILE);
			if(file_temp.exists())
			{
				File file = new File(Const.DOWNLOAD_PATH+Util.GetPackage(mContext)+Const.DOWNLOAD_PLAY_FILE+Util.ExternalName);
				if(file.exists())
				{
					file.delete();
				}
